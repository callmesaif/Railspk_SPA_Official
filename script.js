...
const translations = {
    en: {
        nav_home: "Home", nav_gallery: "Gallery", nav_reviews: "Reviews", nav_community: "Community", nav_about: "About",
        hero_desc: "Documenting the heritage and cinematic evolution of Pakistan Railways through digital storytelling.",
        btn_explore: "Explore Scorecards", stat_subs: "Active Subs", stat_vlogs: "Heritage Vlogs", stat_reach: "Total Reach", stat_uptime: "Cloud Uptime",
        title_vlogs: "Latest Vlogs", title_reviews: "Train Scorecards", search_placeholder: "Search train name...",
        footer_copy: "© 2026 The RAILSPK | Digital Legacy Project", load_more: "Load More", explore_more: "Explore More",
        btn_post: "Post", opinion_placeholder: "Share your experience...", rating_label: "Hub Rating",
        official_broadcast: "Official Broadcast", edit: "Edit", delete: "Delete", show_less: "Show Less", read_more: "READ MORE...",
        comm_discussion: "Community Discussion", observer: "Observer", railspk_reply: "RAILSPK Reply:",
        reply_placeholder: "Reply...", btn_send: "SEND", btn_send_small: "Send", no_opinions: "No opinions yet.",
        write_opinion: "Write your opinion...", no_search_results: "No trains matched your search.", terminal_all: "All Terminals",
        new_broadcast: "New Broadcast", new_opinion: "New Opinion"
    },
    ur: {
        nav_home: "ہوم", nav_gallery: "گیلری", nav_reviews: "ریویوز", nav_community: "کمیونٹی", nav_about: "ہمارے بارے میں",
        hero_desc: "پاکستان ریلویز کی وراثت اور ارتقاء کو ڈیجیٹل کہانیوں کے ذریعے محفوظ کرنا۔",
        btn_explore: "اسکور کارڈز دیکھیں", stat_subs: "سبسکرائبرز", stat_vlogs: "وی لاگز", stat_reach: "رسائی", stat_uptime: "کلاؤڈ ایکٹو",
        title_vlogs: "تازہ ترین وی لاگز", title_reviews: "ٹرین اسکور کارڈز", search_placeholder: "ٹرین کا نام تلاش کریں...",
        footer_copy: "© 2026 دی ریلز پی کے | ڈیجیٹل لیجیسی پروجیکٹ", load_more: "مزید دیکھیں", explore_more: "مزید معلومات",
        btn_post: "پوسٹ", opinion_placeholder: "اپنا تجربہ شیئر کریں...", rating_label: "ریٹنگ",
        official_broadcast: "سرکاری اعلان", edit: "ترمیم", delete: "حذف", show_less: "کم دکھائیں", read_more: "مزید پڑھیں...",
        comm_discussion: "عوامی گفتگو", observer: "مشاہدہ کار", railspk_reply: "ریلز پی کے کا جواب:",
        reply_placeholder: "جواب دیں...", btn_send: "بھیجیں", btn_send_small: "بھیجیں", no_opinions: "ابھی تک کوئی رائے نہیں آئی۔",
        write_opinion: "اپنی رائے لکھیں...", no_search_results: "آپ کی تلاش کے مطابق کوئی ٹرین نہیں ملی۔", terminal_all: "تمام ٹرمینلز",
        new_broadcast: "نیا اعلان", new_opinion: "نئی رائے"
    }
};
...
function renderTrainCards(dataToRender = trainsData) {
    ...
    grid.innerHTML = dataToRender.map(train => {
        const filtered = (allReviews || []).filter(r => r.trainId == train.id).sort((a,b) => b.timestamp - a.timestamp);
        const avg = filtered.length ? filtered.reduce((a, b) => a + b.rating, 0) / filtered.length : 0;
        const slides = train.slides.map(s => 'images/' + s);
...
async function postUpdate(e) {
    ...
    } catch (err) { alert("Failed."); } finally { btn.disabled = false; btn.innerText = "Publish to Cloud"; }
}
